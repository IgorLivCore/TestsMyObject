...
public class Responsibility extends MOTestBase {
    ...
    public void testEdit() throws Exception{
        ...
        //button("Зоны ответственности:");//(//*[@class="col-md-5"]//*[@class="fio"])[1]////////////////////
        button("Изменить");
        select("Сотрудник", 1);
        //Участие в производственном контроле ПБ
        select("Тип ответственности", "Отвечает за работоспособное состояние");
